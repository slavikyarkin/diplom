object Form21: TForm21
  ...
  object uqBook: TUniQuery
    ...
    SQL.Strings = (
      'select b.id'
        ...
        '     , b.name || '#39' '#39' || (select trim(both '#39'{}'#39' from array_agg(a.' +
        'surname || '#39' '#39' || a.name || '#39' '#39' || coalesce(a.patron, '#39#39') )::var' +
        'char )'
      '                           from mm.book_author au '
      '                                join mm.author a '
      '                                  on a.id = au.author_id '
      '         '#9#9'          where au.book_id = b.id) as book'
      '  from mm.book b')
    Left = 200
    Top = 8
  end
  ...
  object uqBookExchange: TUniQuery
    Connection = Form3.con
    SQL.Strings = (
      'select *'

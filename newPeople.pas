...
procedure TForm3.bSaveAllClick(Sender: TObject);
begin
  uqPeople.Append;
  ...
  uqDoc.FieldValues['people_id']:= uqGetPeople.FieldByName('id').AsInteger;
  uqDoc.Post;
...
procedure TForm3.lcbDistrictPropertiesChange(Sender: TObject);
begin
  uqGetRegion.Close;
...
procedure TForm3.lcbRegionPropertiesChange(Sender: TObject);
begin
  uqGetTown.Close;
